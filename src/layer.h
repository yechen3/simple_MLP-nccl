...
namespace cudl {
    ...
    public:
        ...
        Blob<float> *weights() { return weights_; }
        bool has_weight() { return weights_ != nullptr; }
        Blob<float> *biases() { return biases_; }
        bool has_biases() { return biases_ != nullptr; }
    ...
    public:
        Dense(Layer *input_from, std::string name, int device_num, int out_size);
    ...
    public:
        Activation(Layer *input_from, std::string name, int device_num,
        cudnnActivationMode_t mode, float coef = 0.f);
    ...
    public:
        Softmax(Layer *input_from, std::string name,int device_num);
    ...
    public:
        Add(Layer *input_from, Layer *input2_from, std::string name, int device_num);
    ...
    public:
        Pad(Layer *input_from, std::string name, int device_num, 
                std::array<int, 8> paddings, int pad_value);
    ...
    public:
        FusedBatchNormalization(Layer *input_from, std::string name,
        int device_num, cudnnBatchNormMode_t mode);
